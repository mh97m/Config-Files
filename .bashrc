...
alias frsh='sudo php artisan migrate:fresh'
alias rfrsh='sudo php artisan migrate:refresh'
alias opt='sudo php artisan optimize'
alias optclr='sudo php artisan optimize:clear'
alias routes='sudo php artisan route:list'
# alias ports='lsof -i :'
